...
WebUI.click(findTestObject('Object Repository/Page_Cho mng tr li  Firefly III/span_Giao dch'))

WebUI.click(findTestObject('Object Repository/Page_Cho mng tr li  Firefly III/span_Chi ph'))

WebUI.click(findTestObject('Object Repository/Page_Tt c cc chi ph gia 1 thng 1 2024 v 31 _f7584c/a_To giao dch mi'))

WebUI.setText(findTestObject('Object Repository/Page_To rt tin mi  Giao dch  Firefly III/input_S miu t_description'), name)
...
WebUI.setText(findTestObject('Object Repository/Page_To rt tin mi  Giao dch  Firefly III/input_Ti khon ch_destination'), 
    taikhoandich)

WebUI.sendKeys(findTestObject('Object Repository/Page_To rt tin mi  Giao dch  Firefly III/input_Ti khon ch_destination'), 
